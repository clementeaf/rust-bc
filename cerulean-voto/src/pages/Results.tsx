            ...
            return (
              <section key={p.id} className="bg-white rounded-lg border border-neutral-100 p-3">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h2 className="text-base font-semibold">Eleccion #{p.id}</h2>
                ...
                {tally ? (
                    ...
                    <div className="mt-3 mb-2">
                      <div className="flex gap-0.5 h-5 rounded-lg overflow-hidden">
                        ...
                        {tally.abstain_power > 0 && (
                          <div
                            className="bg-neutral-300 flex items-center justify-center text-neutral-600 text-[10px] font-medium"
                  ...
                  <p className="text-sm text-neutral-400 mt-2">Sin votos registrados.</p>
                )}
              </section>
            )
          })
