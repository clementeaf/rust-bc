...
- `src/identity/zkp.rs` — Zero-knowledge proofs over credential claims. Commitment-based scheme (SHA-256 + blinding). 3 predicates: RangeProof, SetMembership, CredentialValidity. Endpoints: `POST /identity/zkp/prove`, `POST /identity/zkp/verify`.
