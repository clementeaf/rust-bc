...
fn main() {
    ...
    println!();
    println!(
        "  Alice→Bob at {}: crystallized={}, support={}/4",
        a,
        field.get(a).crystallized,
        field.orthogonal_support(a)
    );
    println!(
        "  Bob→Carol at {}: crystallized={}, support={}/4",
        b,
        field.get(b).crystallized,
        field.orthogonal_support(b)
    );
    println!(
        "  Midpoint  at {}: crystallized={}, support={}/4",
        mid,
        field.get(mid).crystallized,
        field.orthogonal_support(mid)
    );
    println!();
