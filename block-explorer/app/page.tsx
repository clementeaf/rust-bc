    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <h1 className="text-3xl font-bold text-gray-900">Rust Blockchain Explorer</h1>
          <p className="text-gray-600 mt-1">Explore blocks, transactions, and wallets</p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="flex gap-4">
            <input
              type="text"
              placeholder="Search by block hash, transaction ID, or wallet address..."
