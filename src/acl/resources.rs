...
mod tests {
    ...
    #[test]
    fn resource_names() {
        assert_eq!(AclResource::ChaincodeInvoke.resource_name(), "peer/ChaincodeToChaincode");
        assert_eq!(AclResource::ChaincodeQuery.resource_name(), "peer/ChaincodeQuery");
        assert_eq!(AclResource::BlockEvents.resource_name(), "peer/BlockEvents");
        assert_eq!(AclResource::ChannelConfig.resource_name(), "peer/ChannelConfig");
        assert_eq!(AclResource::PeerDiscovery.resource_name(), "peer/Discovery");
        assert_eq!(AclResource::PrivateDataRead.resource_name(), "peer/PrivateData.Read");
        assert_eq!(AclResource::PrivateDataWrite.resource_name(), "peer/PrivateData.Write");
        assert_eq!(AclResource::Custom("my/Resource".to_string()).resource_name(), "my/Resource");
    }
}
